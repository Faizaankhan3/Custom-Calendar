...
No, need to store data in Database or have a backend api.
 ...
 Custom Calendar
    ...
    Create a custom calendar (Don’t use any library). Default it will be a monthly calendar with the name of the month and year on the top of the calendar.


    Calendar will show the dates of the month and the months can be changed with the previous and next arrow.


    Clicking on each date, a popup will be open which contains a title field to add event on that particular date.
